...
export function ProjectCarouselSkeleton() {
  return (
    <div className="pointer-events-auto flex h-[370px] w-[640px] bg-netbook bg-cover px-[105px] pb-[96px] pt-[16px]">
...
export function ProjectCarousel({ children }: ProjectCarouselProps) {
  ...
  return (
    <div className="flex h-[208px] w-[360px] bg-netbook bg-cover px-[59px] pb-[54px] pt-[9px] sm:h-[370px] sm:w-[640px] sm:px-[105px] sm:pb-[96px] sm:pt-[16px]">
      <div className="pointer-events-auto relative flex grow items-center justify-between overflow-hidden bg-background">
        ...
        {shouldShowButtons && (
          <Button
            ...
            onClick={() => moveIndex(-1)}
            aria-label="move to the previous project"
          >
        ...
        {shouldShowButtons && (
          <Button
            ...
            onClick={() => moveIndex(1)}
            aria-label="move to the following project"
          >
